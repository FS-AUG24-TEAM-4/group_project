      ...
      <div className={styles.rights}>
        <div className={styles.rights__container}>
          ...
          <section className={styles.rights__section}>
            ...
            <p>
              Всі матеріали на цьому сайті захищені авторським правом.
              Заборонено копіювати, поширювати або використовувати будь-який
              контент без попередньої письмової згоди.
            </p>
          </section>
        </div>
      </div>
