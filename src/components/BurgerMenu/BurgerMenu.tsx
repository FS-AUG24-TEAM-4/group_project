  ...
  return (
    ...
    <div className={styles.container}>
      ...
      <nav className={styles.burger__nav}>
        ...
        <a className={styles.burger__nav__links} href="/group_project/tablets">
          Tablets
        </a>

        <a className={styles.burger__nav__links} href="/group_project/accessories">
          Accessories
        </a>
      </nav>
    </div>
    ...
    <footer className={styles.burger__footer}>
      <a href="/group_project/fav" className={styles.burger__footer__links__active}>
        <img
